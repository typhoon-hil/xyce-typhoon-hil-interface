...
class Comparator(SubcircuitBased):
    ...
    def create_new_format_properties_dict(self, tse_properties, tse_component):
        ...
        new_format_properties = {
            "VHI": tse_properties["v_hi"],
            "VLO": tse_properties["v_lo"],
            "VT_HI": tse_properties["vt_hi"] if tse_properties['enable_hysteresis'] == "True" else 0,
            "VT_LO": tse_properties["vt_lo"] if tse_properties['enable_hysteresis'] == "True" else 0,
        }
    ...
    def create_component_model(self, tse_properties, tse_component):
        ...
        model_name = "comparator_hyst" if tse_properties['enable_hysteresis'] == "True" else "comparator"
        ...
        if not component_model:
            component_model = ComponentModel(self.circuit, model_name, file_path=os.path.join(XYCE_INCLUDED_MODELS_PATH, "comparator.lib"))
